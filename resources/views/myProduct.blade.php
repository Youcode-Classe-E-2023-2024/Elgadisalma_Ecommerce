                ...
                <ul role="list" class="mx-4 inline-flex space-x-8 sm:mx-6 lg:mx-0 lg:grid lg:grid-cols-4 lg:gap-x-8 lg:space-x-0 gap-5">
                    ...
                    <form action="{{ route('edit.product', $product->id ) }}" method="POST">
                        ...
                        <div class="group relative">
                            ...
                            <img src="{{ asset('storage/images/' . $product->image) }}" alt="Black machined steel pen with hexagonal grip and small white logo at top." class="h-full w-full object-cover object-center group-hover:opacity-75">
                            </div>
                            <div class="mt-6">
